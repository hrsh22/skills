...
3. Run all structural checks in `docs/validation.md`. Exercise every behavior changed by the release and every path claimed as verified, record each outcome, and retain other unexercised paths as known limitations. Installation success does not satisfy behavioral checks.
